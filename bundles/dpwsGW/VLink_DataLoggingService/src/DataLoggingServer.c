...
static int soap_serve_StartLogging(struct soap *soap) //TODO: pass device context
{
	...
	int op_id = OP_VLinkModel_DataLogging_StartLogging;
	...
	/* prepare response */
	{
		...
		char * Action = "http://www.teco.edu/VLink/DataLoggingService/StartLoggingOut";
...
static int soap_serve_StartDownload(struct soap *soap)
{
	...
	int op_id = OP_VLinkModel_DataLogging_StartDownload;
	int service_id = SRV_DataLogging;
	struct dpws_s *device = NULL;
	...
	/* prepare response */
	{
		const char* To = wsa_header_get_ReplyTo(soap);
		char * MessageId = wsa_header_get_MessageId(soap);
		char * Action = "http://www.teco.edu/VLink/DataLoggingService/StartDownloadOut";
...
static int soap_serve_Erase(struct soap *soap)
{
	...
	int op_id = OP_VLinkModel_DataLogging_Erase;
	int service_id = SRV_DataLogging;
	struct dpws_s *device = NULL;
	...
	/* prepare response */
	{
		const char* To = wsa_header_get_ReplyTo(soap);
		char * MessageId = wsa_header_get_MessageId(soap);
		char * Action = "http://www.teco.edu/VLink/DataLoggingService/EraseOut";
...
static int soap_serve_GetSessionCount(struct soap *soap)
{
	...
	int op_id = OP_VLinkModel_DataLogging_GetSessionCount;
	int service_id = SRV_DataLogging;
	struct dpws_s *device = NULL;
	...
	/* prepare response */
	{
		const char* To = wsa_header_get_ReplyTo(soap);
		char * MessageId = wsa_header_get_MessageId(soap);
		char * Action = "http://www.teco.edu/VLink/DataLoggingService/GetSessionCountOut";
...
int DataLoggingService_serve_request(struct soap *soap)
{
	...
	if ((soap->action && !strcmp(soap->action,
			"http://www.teco.edu/VLink/DataLoggingService/StartLoggingIn"))

	)
		return soap_serve_StartLogging(soap);

	if ((soap->action && !strcmp(soap->action,
			"http://www.teco.edu/VLink/DataLoggingService/StartDownloadIn"))

	)
		return soap_serve_StartDownload(soap);

	if ((soap->action && !strcmp(soap->action,
			"http://www.teco.edu/VLink/DataLoggingService/EraseIn"))

	)
		return soap_serve_Erase(soap);

	if ((soap->action && !strcmp(soap->action,
			"http://www.teco.edu/VLink/DataLoggingService/GetSessionCountIn"))
