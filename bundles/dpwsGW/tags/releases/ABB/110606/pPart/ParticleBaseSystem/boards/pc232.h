/**
*
*	Boardheaderfile für 232
*
*
* file version: 000 (2005-08-24, sabin)
*				identical to pc230.h 000
...
#define BOARD_ID_HIGH		2		// boardtype is particle (1), board_id_high is 1<<1, see docu particle ids
#define BOARD_ID_LOW		232		// boardversion
...
//pins for rssi
#define	TRIS_RSSI_POWER		PIC_TRISF,4
#define PIN_RSSI_POWER		PIN_F4
#define TRIS_RSSI_IN		PIC_TRISA,1
#define PIN_RSSI_IN			PIN_A1
#define ADCH_RSSI			ADCH_PIN_A1

#define PIN_RSSI_RES		PIN_F3
#define TRIS_RSSI_RES		PIC_TRISF, 3
#define PIN_RSSI_CAP		PIN_E1
#define TRIS_RSSI_CAP		PIC_TRISE, 1
#define PIN_RSSI_VDD		PIN_F7
#define TRIS_RSSI_VDD		PIC_TRISF, 7
...
#define PIN_ID_CHIP_POWER	PIN_E6
#define TRIS_ID_CHIP_POWER	PIC_TRISE,6


//pins for the ballswitch
#define TRIS_BALL_INNER		PIC_TRISD,0
#define PIN_BALL_INNER		PIN_D0
