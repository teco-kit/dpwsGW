/*
*
*	particle computer hardware boardfile for particle computer 220
*
*/


/**
* This is the board file for particle computer communication board 220
*
...
int PCSetDigitalPorts(port_settings choice)
{
	switch(choice)
	{
		case NORMAL:
			...
			PIC_TRISD=0b00110010;	PIC_PORTD=0b00001100;
