...
namespace NodeDiscovery.Gateway {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.teco.edu/SensorValues", ConfigurationName="Gateway.SensorValues", CallbackContract=typeof(NodeDiscovery.Gateway.SensorValuesCallback))]
    public interface SensorValues {
        ...
        NodeDiscovery.Gateway.GetSensorValuesResponse GetSensorValues(NodeDiscovery.Gateway.GetSensorValuesRequest request);
        
        // CODEGEN: Generating message contract since the operation Config is neither RPC nor document wrapped.
        [System.ServiceModel.OperationContractAttribute(Action="http://www.teco.edu/SensorValues/ConfigRequest", ReplyAction="http://www.teco.edu/SensorValues/ConfigResponse")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        NodeDiscovery.Gateway.ConfigResponse Config(NodeDiscovery.Gateway.ConfigRequest request);
    }
    ...
    public interface SensorValuesCallback {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        void SensorValuesEvent(NodeDiscovery.Gateway.SensorValuesEvent request);
    }
    ...
    public partial class GetSensorValuesResponse {
        ...
        public NodeDiscovery.Gateway.SSimpSample Sample;
        
        public GetSensorValuesResponse() {
        }
        
        public GetSensorValuesResponse(NodeDiscovery.Gateway.SSimpSample Sample) {
            this.Sample = Sample;
        }
    }
    ...
    public partial class ConfigRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://www.teco.edu/SensorValues", Order=0)]
        public NodeDiscovery.Gateway.SSimpControl StatusControl;
        
        public ConfigRequest() {
        }
        
        public ConfigRequest(NodeDiscovery.Gateway.SSimpControl StatusControl) {
    ...
    public partial class ConfigResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://www.teco.edu/SensorValues", Order=0)]
        public NodeDiscovery.Gateway.SSimpStatus Status;
    ...
    public partial class SensorValuesEvent {
        ...
        public SensorValuesEvent(NodeDiscovery.Gateway.SSimpSample Sample) {
            this.Sample = Sample;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface SensorValuesChannel : NodeDiscovery.Gateway.SensorValues, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SensorValuesClient : System.ServiceModel.DuplexClientBase<NodeDiscovery.Gateway.SensorValues>, NodeDiscovery.Gateway.SensorValues {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        NodeDiscovery.Gateway.GetSensorValuesResponse NodeDiscovery.Gateway.SensorValues.GetSensorValues(NodeDiscovery.Gateway.GetSensorValuesRequest request) {
            return base.Channel.GetSensorValues(request);
        }
        
        public NodeDiscovery.Gateway.SSimpSample GetSensorValues() {
            NodeDiscovery.Gateway.GetSensorValuesRequest inValue = new NodeDiscovery.Gateway.GetSensorValuesRequest();
            NodeDiscovery.Gateway.GetSensorValuesResponse retVal = ((NodeDiscovery.Gateway.SensorValues)(this)).GetSensorValues(inValue);
            return retVal.Sample;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        NodeDiscovery.Gateway.ConfigResponse NodeDiscovery.Gateway.SensorValues.Config(NodeDiscovery.Gateway.ConfigRequest request) {
            return base.Channel.Config(request);
        }
        
        public NodeDiscovery.Gateway.SSimpStatus Config(NodeDiscovery.Gateway.SSimpControl StatusControl) {
            NodeDiscovery.Gateway.ConfigRequest inValue = new NodeDiscovery.Gateway.ConfigRequest();
            inValue.StatusControl = StatusControl;
            NodeDiscovery.Gateway.ConfigResponse retVal = ((NodeDiscovery.Gateway.SensorValues)(this)).Config(inValue);
