/*
*
*	Smart-Its hardware boardfile for particel computer 202
*	todo: define selfttest loopback test pins
*/

//#include "boards\18f6620.h"
//#include "boards\18f6620_R.h"
//#include "boards\18f6620.c"

/**
* This is the board file for particle computer communication board 202
*
* file version: 001 (2003-11-27, cdecker)
*  - first functionality, but incomplete
*
* file version: 002 (2003-11-28, cdecker)
*  - Analog port settings using macros
*
* file version: 003 (2003-12-01, cdecker)
*  - function for analog port settings
*  - function for digital port setting
*
* file version 004 (2004-10-10, krohn)
*  - including the PCGetId for 2/28 compatibility
*
* file version 005 (2004-27-10,wendhack)
*  - fixed bug in function "PCGetId"
*
*/


#ifndef __PC202_C__
#define __PC202_C__             004
