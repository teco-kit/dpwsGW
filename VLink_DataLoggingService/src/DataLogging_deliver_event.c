...
enum DataLogging_operations DataLoggingService_get_opid(char *soap_action_uri) {
	...
	if (0 == strcmp(soap_action_uri,
			"http://www.teco.edu/VLink/DataLoggingService/DataLoggingServiceEventOut"))
		return OP_VLinkModel_DataLogging_DataEvent;
...
char * DataLoggingService_get_opuri(enum DataLogging_operations op) {
	...
	case OP_VLinkModel_DataLogging_DataEvent:
		return "http://www.teco.edu/VLink/DataLoggingService/DataLoggingServiceEventOut";
